...
namespace FStudio.MatchEngine.Input {
    public class TeamInputListener : InputListener {
        ...
        public static event Action<Transform> OnActivePlayerChanged;
        ...
        public PlayerBase ActivePlayer
        {
            ...
            private set
            {
                ...
                // trigger event
                OnActivePlayerChanged?.Invoke(value.PlayerController.UnityObject.transform);
            }
        }
        ...
        public TeamInputListener(
            ...
            inputPointer = UnityEngine.Object.Instantiate(Resources.Load<Transform>("UI/InputPointer"));
            ...
            RegisterAction("Dribble", DribbleInput);
            //
        ...
        private bool DribbleInput(InputAction.CallbackContext ctx)
        {
            if (MatchPause.IsPaused)
            {
                return false;
            ...
            {
                ActivatePlayerBehaviour<InputDribbleBehavior>();
            }
            else
            {
                DectivatePlayerBehaviour<InputDribbleBehavior>();
            }
        ...
        private void AssignPlayer () {
            ...
            {
                //assign a player
                currentBallHolder = gameTeam.GamePlayers[0];
                ActivePlayer = currentBallHolder;
                return;// cannot select another player.
            }

            //
            if (currentBallHolder.GameTeam == gameTeam)
            {
                ActivePlayer = currentBallHolder;
                return;
            }
