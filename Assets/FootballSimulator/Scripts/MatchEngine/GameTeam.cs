...
namespace FStudio.MatchEngine {
    public class GameTeam : MonoBehaviour {
        ...
        public void AddInputListener(int playerIndex) {
            ...
            Debug.Log("[GameTeam] Input listener added to the team.", gameObject);
        }
        ...
        private PlayerBase CreateSinglePlayer(MatchPlayer player) {
            PlayerBase basePlayer = null;
            basePlayer = new CMF(this, player, mainKit);
            //basePlayer = new LB(this, player, mainKit);
            return basePlayer;
        }
        ...
        public void SetTeam(MatchTeam team) {
            ...
            var length = Mathf.Min(team.Players.Length, 1);
            ...
            for (int i = 0; i < length; i++) {
                ...
                var basePlayer = CreateSinglePlayer(team.Players[i]);
        ...
        public void Behave(
            ...
            /*if (GamePlayers.Length < 2)
            {
                ...
                {
                    bool isInput = IsPlayerInputControlled(p);
            ...
            for (int i=0; i < /*11*/GamePlayers.Length; i++) {
        ...
        public void PrePositionDefensiveKickOff(
            ...
            if (GamePlayers.Length <= 1)
            {
                var ballPos = Ball.Current.transform.position;
                GamePlayers[0].PlayerController.SetInstantPosition(new Vector3(15f, 0, 8.5f));
                lookToBall(ballPos, GamePlayers[0]);
                //var targetPosition = new FieldPosition(Positions.DMF);
                //PutPlayerToFieldPosition(GamePlayers[0], targetPosition, goalNet, fieldEndX, fieldEndY, ballPos);
                return;
            }
        ...
        public void PrePositionForOffensiveKickOff(
            ...
            {
                var ballPos = Ball.Current.transform.position;
                KickOff1Player(ballPos, kickerPositioningOffset, excludePosition);
                return;
            }
            ...
            Positions excludePosition = Positions.ParametersCount)
        {
            ...
            var sortedByDistanceToBall = GamePlayers[0];


            var closest = sortedByDistanceToBall;
