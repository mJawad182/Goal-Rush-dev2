...
namespace FStudio.Input {
    internal class InputMobile : MonoBehaviour {
        ...
        internal static void Load() {
            var inputMobilePrefab = Resources.Load<Transform>("UI/InputMobile");
            if (inputMobilePrefab != null) {
                var inputMobile = Instantiate(inputMobilePrefab);
                DontDestroyOnLoad(inputMobile);
            } else {
                Debug.LogError("[InputMobile] Could not find InputMobile prefab at Resources/UI/InputMobile");
            }
        }
