...
namespace FStudio.MatchEngine.Players
{
    ...
    {
        #region tackling
        public const float TACKLING_DISTANCE = 4f;
        ...
        #endregion
        //private bool isTacklingNow = false;
        ...
        public void DoTackle(Ball ball, bool forceTackle = false)
        {
            /*if (isTacklingNow)
                return;*/

            if (IsHoldingBall && !forceTackle)
            {
                return;
            }
